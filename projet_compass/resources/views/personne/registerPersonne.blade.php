                                ...
                                <form class="mx-1 mx-md-4" name="register" method="post" action="{{ route('update', $id) }}" id="register">
                                    ...
                                    <div class="d-flex flex-row align-items-center mb-4">
                                        ...
                                        <div data-mdb-input-init class="form-outline flex-fill mb-0">
                                            ...
                                            <label class="form-label" for="form3Example1c">Sélectionner le statut</label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex flex-row align-items-center mb-4">
                                        <i class="fas fa-envelope fa-lg me-3 fa-fw"></i>
                                        <div data-mdb-input-init class="form-outline flex-fill mb-0">
                                            <input type="text" id="age" class="form-control" name="age" placeholder="Votre age" />
                                    ...
                                    <div class="d-flex flex-row align-items-center mb-4">
                                        ...
                                        <div data-mdb-input-init class="form-outline flex-fill mb-0">
                                            <select name="sexe" id="sexe">
                                                <option value="professeur">femelle</option>
                                                <option value="etudiant">male</option>
                                            </select>
                                            <label class="form-label" for="form3Example1c">Sélectionner vote sexe</label>
                                        </div>
                                    </div>
