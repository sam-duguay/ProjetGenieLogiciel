...
class MessengerServiceProvider extends ServiceProvider
{
    ...
    protected function offerPublishing()
    {
        if ($this->app->runningInConsole()) {
            ...
            $this->publishes([
                __DIR__ . '/../example/views/messenger' => resource_path('views/messenger'),
             ], 'messenger-assets');
             ...
             $this->publishes([
                __DIR__ . '/../example/views/MessagesController.php' => app_path('Http/Controllers/MessagesController.php'),
            ], 'messenger-assets');
        }
    }
